...
As stated in my introduciton. The quiz is centered around the idea of video games and the knowledge base around it. This sets a very large target audience from the start: Gamers. Gaming has one of the largest media audiences in the world, making this quiz very open to many different users. By using general knowledge gaming questions as well it is open to every form of gamer rather than the limitations of a particular genre or console. I will appeal to gamers with a "cooler" color scheme using colours that are familiar to gamers. I have also ensured that the questions I have chosen provide a decent amount of challenge rather than assume the average gamer to be stupid. The questions are challenging enough to create enough competition for a high score.
